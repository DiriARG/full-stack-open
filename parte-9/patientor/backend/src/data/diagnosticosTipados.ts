...
/* Archivo que contiene los diagnósticos tipados de la aplicación.
Esto se realiza para:
- Garantizar que los objetos cumplen con la estructura esperada (code, name y latin opcional). 
- Detectar errores en tiempo de desarrollo si los datos cambian o se usan incorrectamente. 
